<template>
    <div class="general-profile-component">
        <h2 class="title my-3">HỒ SƠ GIA HẠN TẠM TRÚ</h2>
        <div class="bg-white">
        ...
        <div class="d-flex align-center justify-content-between mb-2">
            <h4 class="title-2">Danh sách hồ sơ gia hạn tạm trú</h4>
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const headers = [
            ...
            { title: 'Gia hạn đến ngày', key: 'temporaryResidenceExpiration' },
