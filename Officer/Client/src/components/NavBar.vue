                ...
                <v-navigation-drawer v-model="drawer" :rail="rail" permanent @click="rail = false">
                    ...
                    <v-list dense nav>
                        ...
                        <v-list-item class="list-item no-wrap-text mb-3" value="temporaryResidenceProfile" color="gainsboro"
                            ...
                            <i class="fas fa-address-card pre-icon pre-icon__yellow"></i>
                            Hồ sơ tạm trú
                        </v-list-item>
                        <v-list-group value="Handle">
                            <template v-slot:activator="{ props }">
                                <v-list-item v-bind="props" class="list-item no-wrap-text mb-3" value="profile"
                                    color="gainsboro">
                                    <i class="fas fa-list pre-icon pre-icon__purple"></i>
                                    Hồ sơ tiếp nhận
                                </v-list-item>
                            </template>
                            <v-list-item class="list-item no-wrap-text mb-3" value="temporaryResidenceRegistration"
                                color="gainsboro" @click="goToGeneralProfile">
                                <i class="fa-regular fa-address-card pre-icon pre-icon__purple"></i>
                                Đăng ký tạm trú
                            </v-list-item>
                            <v-list-item class="list-item no-wrap-text mb-3" value="temporaryResidenceExtension"
                                color="gainsboro" @click="goToExtensionProfile">
                                <i class="fa-regular fa-address-card pre-icon pre-icon__purple"></i>
                                Gia hạn tạm trú
                            </v-list-item>
                            <v-list-item class="list-item no-wrap-text mb-3" value="temporaryResidenceDeleteRegistration"
                                color="gainsboro" @click="goToDeleteRegisterProfile">
                                <i class="fa-regular fa-address-card pre-icon pre-icon__purple"></i>
                                Xoá tạm trú
                            </v-list-item>
                        </v-list-group>
...
export default defineComponent({
    ...
    setup() {
        ...
        const goToExtensionProfile = () => {
            router.push({ name: "general_profile_extension" });
        }
        const goToDeleteRegisterProfile = () => {
            router.push({ name: "general_profile_delete_register" });
        }
        const signOut = () => {
        ...
        return {
            ...
            goToExtensionProfile, goToDeleteRegisterProfile,
            signOut,
        }
    }
});
