...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: "/general-profile/extension",
                name: "general_profile_extension",
                component: () => import("@/views/GeneralProfile/ExtensionProfile.vue"),
                props: true,
            },
            {
                path: "/general-profile/extension/:id",
                name: "general_profile_extension.edit",
                component: () => import("@/views/GeneralProfile/ExtensionProfileEdit.vue"),
                props: true,
            },
            {
                path: "/general-profile/delete-register",
                name: "general_profile_delete_register",
                component: () => import("@/views/GeneralProfile/DeleteRegisterProfile.vue"),
                props: true,
            },
            {
                path: "/general-profile/delete-register/:id",
                name: "general_profile_delete_register.edit",
                component: () => import("@/views/GeneralProfile/DeleteRegisterProfileEdit.vue"),
                props: true,
            },
        ]
    }
