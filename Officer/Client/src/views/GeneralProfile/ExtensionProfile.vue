<template>
    <ExtensionProfile :data="dataCopy" @add:generalProfile="addData" @update:generalProfile="updateData"
...
import ExtensionProfile from '@/components/GeneralProfile/ExtensionProfile.vue';
    ...
    setup(props, context) {
        ...
        const addData = async (rq) => {
            try {
                ...
                data = await generalProfileService.getByTypeAndCode(2, ward.code);
