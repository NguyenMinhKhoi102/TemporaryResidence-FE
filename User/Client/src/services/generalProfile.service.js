...
class GeneralProfileService {
    ...
    async getAllByUserIdAndIsCopy(isCopy) {
        return (await this.api.get(`/list/by-user-id/by-is-copy?isCopy=${isCopy}`)).data;
    }
    async getAllByUserId() {
        return (await this.api.get(`/list/by-user-id`)).data;
    }
