<template>
    <ProfileHistory :data="tempData" @filter:data="filterData" @reset:data="getData"></ProfileHistory>
</template>
<script>
import { defineComponent, ref, onMounted } from 'vue';
import ProfileHistory from '../../components/ProfileHistory/ProfileHistory.vue';
