<template>
    <ProfileNotExpired :data="tempData" @filter:data="filterData" @reset:data="getData"></ProfileNotExpired>
</template>
<script>
import { defineComponent, ref, onMounted } from 'vue';
import ProfileNotExpired from '../../components/ProfileNotExpired/ProfileNotExpired.vue';
    ...
    setup(props, context) {
        ...
        onMounted(async () => {
            try {
                ...
                data = await temporaryResidenceService.getAllByIsExpired(1);
                data.sort(
